...
public class OrderController {
    ...
    @PostMapping
    public ResponseEntity<GenericResponseDTO> createPublisher(@RequestBody OrderDTO orderDTO) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<OrderExportDTO> getOrderById(@PathVariable("id") Long id) {
