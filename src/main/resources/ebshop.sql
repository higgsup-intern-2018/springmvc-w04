...
--
-- Host: localhost
-- Generation Time: Aug 03, 2018 at 12:04 PM
...
(5, 'Anna', 'Lee', 1996, 'Test update for author 1', 'www.test1.com', 'free'),
...
(10, 'HaiAnh', 'Pham', 1996, 'Test update for author 1', 'www.test1.com', 'free'),
...
(5, '12345678X', 'test1', 'this is test', NULL, NULL, '2018-02-04', 54, '5.00', 6, 0),
...
(10, '123456789X', 'test2', 'this is test 2', 1, 4, '2018-07-24', 254, '5.44', 6, 0),
...
INSERT INTO `person` (`id`, `age`, `first_name`, `last_name`) VALUES
(1, 25, 'Paul', 'Pogba'),
(2, 22, 'Benjamin', 'Pavard'),
(3, 27, 'Antoine', 'Griezmann'),
(4, 19, 'Kylian', 'Mbappé'),
(5, 27, 'Kevin', 'De Bruyne'),
(6, 27, 'Eden', 'Hazard');
...
ALTER TABLE `order_details`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UC_DETAIL` (`order_id`,`ebook_id`),
